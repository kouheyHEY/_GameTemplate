...
```
YYYY-MM-DD_NN_変更内容の簡潔な説明.md
```

- `YYYY-MM-DD`: 日付
- `NN`: 連番（01, 02, 03...）同じ日付に複数の履歴がある場合に使用
- `変更内容の簡潔な説明`: 変更内容を端的に表す日本語

**例:**

- `2026-02-13_01_プロジェクト初期構想.md`
- `2026-02-13_02_テキスト管理システム実装.md`
- `2026-02-13_03_コアプリロードシステム導入.md`
- `2026-02-10_01_ステートマシン設計変更.md`
- `2026-01-25_01_チュートリアルシステム実装.md`
...
- **カテゴリ**: 設計・実装
- **概要**: JSON形式のダイアログデータ構造とDialogueManagerを実装
```
